...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 20, 631, 541))
        ...
        self.pushButton_2.setStyleSheet("background-color: rgb(253, 245, 230)")
        self.pushButton_2.setObjectName("pushButton_2")
        self.horizontalLayout_3.addWidget(self.pushButton_2)
        self.pushButton_3 = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.pushButton_3.setStyleSheet("background-color: rgb(253, 245, 230)")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "number in school"))
        self.menu.setTitle(_translate("MainWindow", "Поиск и изменеие данных"))
